# Flow Launcher Toolset

This repository contains the Flow Launcher plugin folders:
...
- If you want to keep a local copy, back it up before running the installer.
